...
CUW_BUILD_ENV = {"CMAKE_LIBRARY_PATH": "$PREFIX/Lib/site-packages/torch/lib", "FFMPEG_ROOT": "$PREFIX/Library", "SOX_INCLUDE_DIR": "$PREFIX/Library/include"}  # from package.yml build_env
