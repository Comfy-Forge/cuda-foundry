...
export NVCC_PREPEND_FLAGS="-I$SRC_DIR/third_party/cccl/libcudacxx/include -I$SRC_DIR/third_party/cccl/cub -I$SRC_DIR/third_party/cccl/thrust $NVCC_PREPEND_FLAGS"
